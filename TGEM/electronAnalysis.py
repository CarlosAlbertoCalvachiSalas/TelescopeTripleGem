...
def readElectronData(ar, energy, V, showHists = False, showDistribution = False):
	filePath = 'dataElectronsAr{}E{}V{}.csv'.format(ar, energy, V)
	...
	xAll = xAll[zAll == -0.603000]
	yAll = yAll[zAll == -0.603000] 
	eAll = eAll[zAll == -0.603000] 
...
readElectronData(70, 9, 400, showHists = True, showDistribution = True)
