// *********************************************************************
// Single GEM cell with biconical holes
// *********************************************************************
// Parameters
...
// distance from GEM plates to upper exterior electrode
lP = 0.2;     // distance from lower GEM plate to pad (readout) plane
a = 0.014;     // the "pitch", or distance between GEM holes
// Characteristic lengths
lcDielectricHole = 0.0004;
lcEtchingHole = 0.0015;
lcCopperPlateBdry = 0.0015;
lcExtElectrodeBdry = 0.0015;
lcGEMHole = 0.0004;
// ------------------------------------------------------------
// Hole 1 (quarter hole)
// ------------------------------------------------------------
...
// Lower boundary
lcpt6 = newc; Line(lcpt6) = {pc1_1,pth2_1};
...
// Lower boundary
lcpb6 = newc; Line(lcpb6) = {pc2_1,pbh2_1};  // starts at point 1 and goes CW
...
// Bottom electrode
pexeb1 = newp; Point(pexeb1) = {a, a, -1*(tD+2*tC)/2-lP,lcExtElectrodeBdry};
pexeb2 = newp; Point(pexeb2) = {a/2, a, -1*(tD+2*tC)/2-lP,lcExtElectrodeBdry};
pexeb3 = newp; Point(pexeb3) = {0, a, -1*(tD+2*tC)/2-lP,lcExtElectrodeBdry};
...
llcp_up_rim1_2 = newreg; Line Loop(llcp_up_rim1_2) = {-lue1_2, -cth1_2, lue3_2,
ctue1_2};
rscp_up_rim1_2 = newreg; Surface(rscp_up_rim1_2) = {llcp_up_rim1_2};
llcp_up_rim2_2 = newreg; Line Loop(llcp_up_rim2_2) = {lue2_2, -1*cth2_2, -1*lue3_2
    , ctue2_2};
rscp_up_rim2_2 = newreg; Surface(rscp_up_rim2_2) = {llcp_up_rim2_2};
llcp_up_rim_1 = newreg; Line Loop(llcp_up_rim_1) = {lcpt29, cth1_1, -lcpt28, -
    ctue1_1};
rscp_up_rim_1 = newreg; Surface(rscp_up_rim_1) = {llcp_up_rim_1};
llcp_up_rim_3 = newreg; Line Loop(llcp_up_rim_3) = {lcpt27, -cth1_3, -lcpt26,
ctue1_3};
rscp_up_rim_3 = newreg; Surface(rscp_up_rim_3) = {llcp_up_rim_3};
llcp_up_border1 = newreg; Line Loop(llcp_up_border1) = {lcpt26, -lcpt14, -lcpt22,
    -lcpt4};
pscp_up_border1 = newreg; Plane Surface(pscp_up_border1) = {llcp_up_border1};
llcp_up_border2 = newreg; Line Loop(llcp_up_border2) = {lue1_2, -lcpt9, -lcpt23, -
    lcpt1};
pscp_up_border2 = newreg; Plane Surface(pscp_up_border2) = {llcp_up_border2};
llcp_up_border3 = newreg; Line Loop(llcp_up_border3) = {-lcpt2, -lcpt29, -lcpt8,
lcpt23};
pscp_up_border3 = newreg; Plane Surface(pscp_up_border3) = {llcp_up_border3};
llcp_up_border4a = newreg; Line Loop(llcp_up_border4a) = {-lcpt3b, -lcpt27, -
    lcpt19a, lsqt1};
pscp_up_border4a = newreg; Plane Surface(pscp_up_border4a) = {llcp_up_border4a};
llcp_up_border4b = newreg; Line Loop(llcp_up_border4b) = {-lcpt3a, lcpt28, -
lcpt19b, -lsqt1};
pscp_up_border4b = newreg; Plane Surface(pscp_up_border4b) = {llcp_up_border4b};
llcp_up_border5 = newreg; Line Loop(llcp_up_border5) = {-lcpt5, -lue2_2, -lcpt13,
lcpt22};
pscp_up_border5 = newreg; Plane Surface(pscp_up_border5) = {llcp_up_border5};
llcp_low_rim1_2 = newreg; Line Loop(llcp_low_rim1_2) = {-lle1_2, cbh1_2, lle3_2, -
    cble1_2};
rscp_low_rim1_2 = newreg; Surface(rscp_low_rim1_2) = {llcp_low_rim1_2};
llcp_low_rim2_2 = newreg; Line Loop(llcp_low_rim2_2) = {lle2_2, cbh2_2, -lle3_2, -
cble2_2};

rscp_low_rim2_2 = newreg; Surface(rscp_low_rim2_2) = {llcp_low_rim2_2};
llcp_low_rim_1 = newreg; Line Loop(llcp_low_rim_1) = {lcpb29, -cbh1_1, -lcpb28,
cble1_1};
rscp_low_rim_1 = newreg; Surface(rscp_low_rim_1) = {llcp_low_rim_1};
llcp_low_rim_3 = newreg; Line Loop(llcp_low_rim_3) = {lcpb27, cbh1_3, -lcpb26, -
cble1_3};
rscp_low_rim_3 = newreg; Surface(rscp_low_rim_3) = {llcp_low_rim_3};
llcp_low_border1 = newreg; Line Loop(llcp_low_border1) = {lcpb26, lcpb14, -lcpb22,
     lcpb4};
pscp_low_border1 = newreg; Plane Surface(pscp_low_border1) = {llcp_low_border1};
llcp_low_border2 = newreg; Line Loop(llcp_low_border2) = {lle1_2, lcpb9, -lcpb23,
lcpb1};
pscp_low_border2 = newreg; Plane Surface(pscp_low_border2) = {llcp_low_border2};
llcp_low_border3 = newreg; Line Loop(llcp_low_border3) = {lcpb2, -lcpb29, lcpb8,
lcpb23};
pscp_low_border3 = newreg; Plane Surface(pscp_low_border3) = {llcp_low_border3};
llcp_low_border4a = newreg; Line Loop(llcp_low_border4a) = {lcpb19a, lsqt3, lcpb3b
, -lcpb27};
pscp_low_border4a = newreg; Plane Surface(pscp_low_border4a) = {llcp_low_border4a
    };
llcp_low_border4b = newreg; Line Loop(llcp_low_border4b) = {lcpb19b, lcpb28,
    lcpb3a, -lsqt3};
pscp_low_border4b = newreg; Plane Surface(pscp_low_border4b) = {llcp_low_border4b
};
llcp_low_border5 = newreg; Line Loop(llcp_low_border5) = {lcpb5, -lle2_2, lcpb13,
lcpb22};
pscp_low_border5 = newreg; Plane Surface(pscp_low_border5) = {llcp_low_border5};
llcp_face1 = newreg; Line Loop(llcp_face1) = {lcpt2, ctue1_1, lcpt3a, lcpt3b, -1*
    ctue1_3, lcpt4, lcpt5, -1*ctue2_2, -1*ctue1_2, lcpt1};
pscp_face1 = newreg; Plane Surface(pscp_face1) = {llcp_face1};
llcp_face2 = newreg; Line Loop(llcp_face2) = {-lcpb1, -lcpb2, -cble1_1, -lcpb3a, -
    lcpb3b, cble1_3, -lcpb4, -lcpb5, cble2_2, cble1_2};
pscp_face2 = newreg; Plane Surface(pscp_face2) = {llcp_face2};
// Dielectric surfaces
ll_up_dielectric_1 = newreg; Line Loop(ll_up_dielectric_1) = {lconn3_1, -cth1_1, -
    lconn4_1, cmh1_1};
ps_up_dielectric_1 = newreg; Surface(ps_up_dielectric_1) = {ll_up_dielectric_1};
ll_low_dielectric_1 = newreg; Line Loop(ll_low_dielectric_1) = {lconn1_1, -cmh1_1,
     -lconn2_1, cbh1_1};
ps_low_dielectric_1 = newreg; Surface(ps_low_dielectric_1) = {ll_low_dielectric_1
};
ll_up_dielectric_2a = newreg; Line Loop(ll_up_dielectric_2a) = {lconn4_2, cth1_2,
    -lconn6_2,-cmh1_2};
ps_up_dielectric_2a = newreg; Surface(ps_up_dielectric_2a) = {ll_up_dielectric_2a
};
ll_up_dielectric_2b = newreg; Line Loop(ll_up_dielectric_2b) = {cth2_2, -lconn5_2,
     -cmh2_2, lconn6_2};
ps_up_dielectric_2b = newreg; Surface(ps_up_dielectric_2b) = {ll_up_dielectric_2b
    };
ll_low_dielectric_2a = newreg; Line Loop(ll_low_dielectric_2a) = {lconn1_2, cmh1_2
    , -lconn3_2, -cbh1_2};

ps_low_dielectric_2a = newreg; Surface(ps_low_dielectric_2a) = {
ll_low_dielectric_2a};
ll_low_dielectric_2b = newreg; Line Loop(ll_low_dielectric_2b) = {lconn3_2, cmh2_2
, -lconn2_2, -cbh2_2};
ps_low_dielectric_2b = newreg; Surface(ps_low_dielectric_2b) = {
    ll_low_dielectric_2b};
ll_up_dielectric_3 = newreg; Line Loop(ll_up_dielectric_3) = {lconn3_3, -cth1_3, -
    lconn4_3, cmh1_3};
ps_up_dielectric_3 = newreg; Surface(ps_up_dielectric_3) = {ll_up_dielectric_3};
ll_low_dielectric_3 = newreg; Line Loop(ll_low_dielectric_3) = {lconn1_3, -cmh1_3,
-lconn2_3, cbh1_3};
ps_low_dielectric_3 = newreg; Surface(ps_low_dielectric_3) = {ll_low_dielectric_3
};
ll_side_dielectric1a = newreg; Line Loop(ll_side_dielectric1a) = {lcpt19b, -
    lconn3_1, -lconn1_1, -lcpb19b, -lsqt2};
ps_side_dielectric1a = newreg; Plane Surface(ps_side_dielectric1a) = {
    ll_side_dielectric1a};
ll_side_dielectric1c = newreg; Line Loop(ll_side_dielectric1c) = {lcpt19a, lsqt2,
-lcpb19a, lconn1_3, lconn3_3};
ps_side_dielectric1c = newreg; Plane Surface(ps_side_dielectric1c) = {
ll_side_dielectric1c};
ll_side_dielectric2a = newreg; Line Loop(ll_side_dielectric2a) = {lcpt14, -
    lconn4_3, -lconn2_3, -lcpb14, -lcpb31};
ps_side_dielectric2a = newreg; Plane Surface(ps_side_dielectric2a) = {
    ll_side_dielectric2a};
ll_side_dielectric3a = newreg; Line Loop(ll_side_dielectric3a) = {lcpt13, lcpb31,
    -lcpb13, lconn2_2, lconn5_2};
ps_side_dielectric3a = newreg; Plane Surface(ps_side_dielectric3a) = {
    ll_side_dielectric3a};
ll_side_dielectric4a = newreg; Line Loop(ll_side_dielectric4a) = {lcpt9, -lconn4_2
, -lconn1_2, -lcpb9, -lcpb32};
ps_side_dielectric4a = newreg; Plane Surface(ps_side_dielectric4a) = {
    ll_side_dielectric4a};
ll_side_dielectric5a = newreg; Line Loop(ll_side_dielectric5a) = {lcpt8, lcpb32, -
    lcpb8, lconn2_1, lconn4_1};
ps_side_dielectric5a = newreg; Plane Surface(ps_side_dielectric5a) = {
    ll_side_dielectric5a};
ll_top_dielectric = newreg; Line Loop(ll_top_dielectric) = {lcpt9, cth1_2, cth2_2,
     lcpt13, lcpt14, cth1_3, lcpt19a, lcpt19b, -cth1_1, lcpt8};
ps_top_dielectric = newreg; Plane Surface(ps_top_dielectric) = {ll_top_dielectric
};
ll_bottom_dielectric = newreg; Line Loop(ll_bottom_dielectric) = {-lcpb19a, -
lcpb19b, cbh1_1, -lcpb8, -lcpb9, -cbh1_2, -cbh2_2, -lcpb13, -lcpb14, -cbh1_3};
ps_bottom_dielectric = newreg; Plane Surface(ps_bottom_dielectric) = {
    ll_bottom_dielectric};
// ------------------------------------------------------------
// Boundary surfaces
// ------------------------------------------------------------
ll_bsurf1 = newreg; Line Loop(ll_bsurf1) = {lcpt17, -lconn3_3, -lconn1_3, -lcpb17,
-lcpb33};
ps_bsurf1 = newreg; Plane Surface(ps_bsurf1) = {ll_bsurf1};


ll_bsurf2 = newreg; Line Loop(ll_bsurf2) = {lcpb33, -lcpb16, lconn2_3, lconn4_3,
lcpt16};
ps_bsurf2 = newreg; Plane Surface(ps_bsurf2) = {ll_bsurf2};
ll_bsurf3a = newreg; Line Loop(ll_bsurf3a) = {lconn4_2, lcpt11a, lshalf2, -lcpb11a
    , lconn1_2};
ps_bsurf3a = newreg; Plane Surface(ps_bsurf3a) = {ll_bsurf3a};
ll_bsurf3b = newreg; Line Loop(ll_bsurf3b) = {lcpt11b, -lconn5_2, -lconn2_2, -
    lcpb11b, -lshalf2};
ps_bsurf3b = newreg; Plane Surface(ps_bsurf3b) = {ll_bsurf3b};
ll_bsurf4 = newreg; Line Loop(ll_bsurf4) = {lcpt6, -lconn4_1, -lconn2_1, -lcpb6, -
    lcpb30};
...
ll_bsurf6a = newreg; Line Loop(ll_bsurf6a) = {-lexet1, -lexetc2, -lshalf1, -
    lcpt11b, lue2_2, lcpt5, lexetc1};
ps_bsurf6a = newreg; Plane Surface(ps_bsurf6a) = {ll_bsurf6a};
ll_bsurf6b = newreg; Line Loop(ll_bsurf6b) = {-lexet2, -lexetc3, lcpt1, -lue1_2, -
    lcpt11a, lshalf1, lexetc2};
ps_bsurf6b = newreg; Plane Surface(ps_bsurf6b) = {ll_bsurf6b};
ll_bsurf7a = newreg; Line Loop(ll_bsurf7a) = {-lexet5, -lexetc6, -lcpt25, -lcpt17,
lcpt27, lcpt3b, lexetc5};
ps_bsurf7a = newreg; Plane Surface(ps_bsurf7a) = {ll_bsurf7a};
ll_bsurf7b = newreg; Line Loop(ll_bsurf7b) = {-lexet4, lexetc4, lcpt24, -lcpt21, -
lcpt28, lcpt3a, -lexetc5};
ps_bsurf7b = newreg; Plane Surface(ps_bsurf7b) = {ll_bsurf7b};
ll_bsurf8 = newreg; Line Loop(ll_bsurf8) = {-lexetc4, -lcpt24, -lcpt6, lcpt29,
lcpt2, lexetc3, -lexet3};
ps_bsurf8 = newreg; Plane Surface(ps_bsurf8) = {ll_bsurf8};
ll_bsurf9 = newreg; Line Loop(ll_bsurf9) = {lexet1, lexet2, lexet3, lexet4, lexet5
    , lexet6};
ps_bsurf9 = newreg; Plane Surface(ps_bsurf9) = {ll_bsurf9};
ll_bsurf10 = newreg; Line Loop(ll_bsurf10) = {-lexebc6, lcpb25, lcpb16, -lcpb26, -
    lcpb4, lexebc1, lexeb6};
ps_bsurf10 = newreg; Plane Surface(ps_bsurf10) = {ll_bsurf10};
ll_bsurf11a = newreg; Line Loop(ll_bsurf11a) = {-lexebc5, -lcpb3b, lcpb27, lcpb17,
-lcpb25, lexebc6, lexeb5};
ps_bsurf11a = newreg; Plane Surface(ps_bsurf11a) = {ll_bsurf11a};
ll_bsurf11b = newreg; Line Loop(ll_bsurf11b) = {lexebc5, -lcpb3a, -lcpb28, lcpb21,
lcpb24, -lexebc4, lexeb4};
ps_bsurf11b = newreg; Plane Surface(ps_bsurf11b) = {ll_bsurf11b};
ll_bsurf12 = newreg; Line Loop(ll_bsurf12) = {-lexebc3, -lcpb2, lcpb29, lcpb6, -
lcpb24, lexebc4, lexeb3};
ps_bsurf12 = newreg; Plane Surface(ps_bsurf12) = {ll_bsurf12};
ll_bsurf13a = newreg; Line Loop(ll_bsurf13a) = {lexeb1, lexebc2, -lshalf3, lcpb11b
    , lle2_2, -lcpb5, -lexebc1};
ps_bsurf13a = newreg; Plane Surface(ps_bsurf13a) = {ll_bsurf13a};
ll_bsurf13b = newreg; Line Loop(ll_bsurf13b) = {lexeb2, lexebc3, -lcpb1, -lle1_2,
    lcpb11a, lshalf3, -lexebc2};
ps_bsurf13b = newreg; Plane Surface(ps_bsurf13b) = {ll_bsurf13b};
ll_bsurf14 = newreg; Line Loop(ll_bsurf14) = {-lexeb1, -lexeb2, -lexeb3, -lexeb4,
    -lexeb5, -lexeb6};
ps_bsurf14 = newreg; Plane Surface(ps_bsurf14) = {ll_bsurf14};
ll_bsurf15 = newreg; Line Loop(ll_bsurf15) = {lexetc6, lcpt25, -lcpt16, -lcpt26,
lcpt4, -lexetc1, -lexet6};

ps_bsurf15 = newreg; Plane Surface(ps_bsurf15) = {ll_bsurf15};
// ------------------------------------------------------------
// Volumes
// ------------------------------------------------------------
sl_dielectric = newreg; Surface Loop(sl_dielectric) = {ps_top_dielectric,
ps_bottom_dielectric, ps_side_dielectric1a, ps_side_dielectric1c,
ps_up_dielectric_1, ps_up_dielectric_3, ps_low_dielectric_1,
ps_low_dielectric_3, ps_side_dielectric2a, ps_side_dielectric3a,
ps_side_dielectric4a, ps_side_dielectric5a, ps_up_dielectric_2a,
ps_up_dielectric_2b, ps_low_dielectric_2a, ps_low_dielectric_2b};
vol_dielectric = newreg; Volume(vol_dielectric) = {sl_dielectric};
sl_gas = newreg; Surface Loop(sl_gas) = {ps_bsurf9, ps_bsurf6a, ps_bsurf6b,
ps_bsurf15, ps_bsurf7a, ps_bsurf7b, ps_bsurf8, ps_bsurf4, ps_bsurf12,
ps_bsurf14, ps_bsurf11a, ps_bsurf11b, ps_bsurf5, ps_bsurf1, ps_bsurf2,
ps_bsurf10, ps_bsurf13a, ps_bsurf13b, ps_bsurf3a, ps_bsurf3b, -rscp_low_rim2_2
, -rscp_low_rim_1, -rscp_low_rim_3, -rscp_low_rim1_2, -rscp_up_rim2_2, -
rscp_up_rim1_2, -pscp_face1, -pscp_face2, -rscp_up_rim_1, -ps_up_dielectric_3,
 -ps_low_dielectric_3, -rscp_up_rim_3, -ps_up_dielectric_1, -
ps_low_dielectric_1, ps_up_dielectric_2a, ps_up_dielectric_2b,
ps_low_dielectric_2a, ps_low_dielectric_2b};
vol_gas = newreg; Volume(vol_gas) = {sl_gas};
sl_upper_cp = newreg; Surface Loop(sl_upper_cp) = {pscp_face1, rscp_up_rim_1,
rscp_up_rim_3, rscp_up_rim2_2, rscp_up_rim1_2, ps_top_dielectric,
pscp_up_border4a, pscp_up_border4b, pscp_up_border3, pscp_up_border2,
pscp_up_border5, pscp_up_border1};
vol_upper_cp = newreg; Volume(vol_upper_cp) = {sl_upper_cp};
sl_lower_cp = newreg; Surface Loop(sl_lower_cp) = {pscp_face2,
    ps_bottom_dielectric, rscp_low_rim_1, rscp_low_rim_3, rscp_low_rim2_2,
    rscp_low_rim1_2, pscp_low_border3, pscp_low_border2, pscp_low_border4a,
pscp_low_border4b, pscp_low_border1, pscp_low_border5};
vol_lower_cp = newreg; Volume(vol_lower_cp) = {sl_lower_cp};
// ------------------------------------------------------------
// Physical Surfaces
// ------------------------------------------------------------
// Surfaces to which voltages will be applied
physsurf_upper_cp = newreg; Physical Surface(physsurf_upper_cp) = {pscp_face1,
rscp_up_rim_1, rscp_up_rim_3, rscp_up_rim2_2, rscp_up_rim1_2,
ps_top_dielectric, pscp_up_border4a, pscp_up_border4b, pscp_up_border3,
pscp_up_border2, pscp_up_border5, pscp_up_border1};
physsurf_lower_cp = newreg; Physical Surface(physsurf_lower_cp) = {pscp_face2,
    ps_bottom_dielectric, rscp_low_rim_1, rscp_low_rim_3, rscp_low_rim2_2,
rscp_low_rim1_2, pscp_low_border3, pscp_low_border2, pscp_low_border4a,
    pscp_low_border4b, pscp_low_border1, pscp_low_border5};
...
physsurf_bd1h1 = newreg; Physical Surface(physsurf_bd1h1) = {ps_bsurf5, ps_bsurf7b
    , ps_side_dielectric1a, ps_bsurf11b};
physsurf_bd1h2 = newreg; Physical Surface(physsurf_bd1h2) = {ps_side_dielectric3a,
     ps_bsurf6a, ps_bsurf13a, ps_bsurf3b};


physsurf_bd2h3 = newreg; Physical Surface(physsurf_bd2h3) = {ps_bsurf1, ps_bsurf7a
, ps_side_dielectric1c, ps_bsurf11a};
physsurf_bd2h2 = newreg; Physical Surface(physsurf_bd2h2) = {ps_side_dielectric4a,
ps_bsurf6b, ps_bsurf13b, ps_bsurf3a};
physsurf_bd3h1 = newreg; Physical Surface(physsurf_bd3h1) = {ps_bsurf8,
ps_side_dielectric5a, ps_bsurf4, ps_bsurf12};
physsurf_bd3h3 = newreg; Physical Surface(physsurf_bd3h3) = {ps_bsurf15,
    ps_side_dielectric2a, ps_bsurf2, ps_bsurf10};
// ------------------------------------------------------------
// Physical Volumes
// ------------------------------------------------------------
